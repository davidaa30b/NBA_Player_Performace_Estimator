...
from performance_estimator.constants import TEAM_FULL_NAMES, TEAMS, Stats
from performance_estimator.utils.minutes_operations import minutes_to_average
...
class ModelLoader():
    ...
    def __init__(self,player:Player,input_season:int,last_number_games):
        ...
        self.round_index_end =  self.last_number_games
        self.datas_played = []
    ...
    def model_load_data(self, stat = Stats.POINTS ):
        ...
        for game in range( self.last_number_games,self.player_games_count):
            ...
            data[ f'minutes_played_last{ self.last_number_games}'].append(minutes_to_average(self.minutes_played_games[self.round_index_begin:self.round_index_end]))
            data['started'].append(self.games_started[game])
            data[ f'player_ppg'].append(np.mean(self.player_points[:self.round_index_end]))
            data[ f'player_ppg_last{ self.last_number_games}'].append(np.mean(self.player_points[self.round_index_begin:self.round_index_end]))
            data['player_field_goals'].append(np.mean(self.player_field_goals[:self.round_index_end]))
            data[ f'player_field_goals_last{ self.last_number_games}'].append(np.mean(self.player_field_goals[self.round_index_begin:self.round_index_end]))
            data[ f'player_field_goals_attempted'].append(np.mean(self.player_field_goals_attempted[:self.round_index_end]))
            data[ f'player_field_goals_attempted_last{ self.last_number_games}'].append(np.mean(self.player_field_goals_attempted[self.round_index_begin:self.round_index_end]))
            data[ f'player_field_goal_percentage'].append(np.mean(self.player_field_goal_percentage[:self.round_index_end]))
            data[ f'player_field_goal_percentage_last{ self.last_number_games}'].append(np.mean(self.player_field_goal_percentage[self.round_index_begin:self.round_index_end]))
            data[ f'player_three_pointers'].append(np.mean(self.player_three_pointers[:self.round_index_end]))
            data[ f'player_three_pointers_last{ self.last_number_games}'].append(np.mean(self.player_three_pointers[self.round_index_begin:self.round_index_end]))
            data[ f'player_three_pointers_attempted'].append(np.mean(self.player_three_pointers_attempted[:self.round_index_end]))
            data[ f'player_three_pointers_attempted_last{ self.last_number_games}'].append(np.mean(self.player_three_pointers_attempted[self.round_index_begin:self.round_index_end]))
            data[ f'player_three_pointers_percentage'].append(np.mean(self.player_three_pointers_percentage[:self.round_index_end]))
            data[ f'player_three_pointers_percentage_last{ self.last_number_games}'].append(np.mean(self.player_three_pointers_percentage[self.round_index_begin:self.round_index_end]))
            data[ f'player_free_throws'].append(np.mean(self.player_free_throws[:self.round_index_end]))
            data[ f'player_free_throws_last{ self.last_number_games}'].append(np.mean(self.player_free_throws[self.round_index_begin:self.round_index_end]))
            data[ f'player_free_throws_attempted'].append(np.mean(self.player_free_throws_attempted[:self.round_index_end]))
            data[ f'player_free_throws_attempted_last{ self.last_number_games}'].append(np.mean(self.player_free_throws_attempted[self.round_index_begin:self.round_index_end]))
            data[ f'player_free_throw_percentage'].append(np.mean(self.player_free_throw_percentage[:self.round_index_end]))
            data[ f'player_free_throw_percentage_last{ self.last_number_games}'].append(np.mean(self.player_free_throw_percentage[self.round_index_begin:self.round_index_end]))
            data[ f'player_total_rebounds'].append(np.mean(self.player_total_rebounds[self.round_index_begin:self.round_index_end]))
            data[ f'player_total_rebounds_last{ self.last_number_games}'].append(np.mean(self.player_total_rebounds[:self.round_index_end]))
            data[ f'player_assists'].append(np.mean(self.player_assists[self.round_index_begin:self.round_index_end]))
            data[ f'player_assists_last{ self.last_number_games}'].append(np.mean(self.player_assists[:self.round_index_end]))
            data[ f'player_steals'].append(np.mean(self.player_steals[self.round_index_begin:self.round_index_end]))
            data[ f'player_steals_last{ self.last_number_games}'].append(np.mean(self.player_steals[:self.round_index_end]))
            data[ f'player_blocks'].append(np.mean(self.player_blocks[self.round_index_begin:self.round_index_end]))
            data[ f'player_blocks_last{ self.last_number_games}'].append(np.mean(self.player_blocks[:self.round_index_end]))
            data[ f'player_turnovers'].append(np.mean(self.player_turnovers[self.round_index_begin:self.round_index_end]))
            data[ f'player_turnovers_last{ self.last_number_games}'].append(np.mean(self.player_turnovers[:self.round_index_end]))
            data[ f'player_game_score'].append(np.mean(self.player_game_score[:self.round_index_end]))
            data[ f'player_game_score_last{ self.last_number_games}'].append(np.mean(self.player_game_score[self.round_index_begin:self.round_index_end]))
            data[ f'player_personal_fouls'].append(np.mean(self.player_personal_fouls[:self.round_index_end]))
            data[ f'player_personal_fouls_last{ self.last_number_games}'].append(np.mean(self.player_personal_fouls[self.round_index_begin:self.round_index_end]))
            data[ f'player_plus_minus'].append(np.mean([int(pm) for pm in self.player_plus_minus[:self.round_index_end]]))
            data[ f'player_plus_minus_last{ self.last_number_games}'].append(np.mean([int(pm) for pm in self.player_plus_minus[self.round_index_begin:self.round_index_end]]))
            data[ f'player_true_shooting_percentage'].append(np.mean(self.player_true_shooting_percentage[:self.round_index_end]))
            data[ f'player_true_shooting_percentage_last{ self.last_number_games}'].append(np.mean(self.player_true_shooting_percentage[self.round_index_begin:self.round_index_end]))
            ...
            data[ f'player_effective_field_goal_percentage_last{ self.last_number_games}'].append(np.mean(self.player_effective_field_goal_percentage[self.round_index_begin:self.round_index_end]))
            data[ f'player_total_rebound_percentage'].append(np.mean(self.player_total_rebound_percentage[:self.round_index_end]))
            data[ f'player_total_rebound_percentage_last{ self.last_number_games}'].append(np.mean(self.player_total_rebound_percentage[self.round_index_begin:self.round_index_end]))
            data[ f'player_assist_percentage'].append(np.mean(self.player_assist_percentage[:self.round_index_end]))
            data[ f'player_assist_percentage_last{ self.last_number_games}'].append(np.mean(self.player_assist_percentage[self.round_index_begin:self.round_index_end]))
            data[ f'player_steal_percentage'].append(np.mean(self.player_steal_percentage[:self.round_index_end]))
            data[ f'player_steal_percentage_last{ self.last_number_games}'].append(np.mean(self.player_steal_percentage[self.round_index_begin:self.round_index_end]))        
            data[ f'player_block_percentage'].append(np.mean(self.player_block_percentage[:self.round_index_end]))
            data[ f'player_block_percentage_last{ self.last_number_games}'].append(np.mean(self.player_block_percentage[self.round_index_begin:self.round_index_end]))
            data[ f'player_turnover_percentage'].append(np.mean(self.player_turnover_percentage[:self.round_index_end]))
            data[ f'player_turnover_percentage_last{ self.last_number_games}'].append(np.mean(self.player_turnover_percentage[self.round_index_begin:self.round_index_end]))
            data[ f'player_offensive_rating'].append(np.mean(self.player_offensive_rating[:self.round_index_end]))
            data[ f'player_offensive_rating_last{ self.last_number_games}'].append(np.mean(self.player_offensive_rating[self.round_index_begin:self.round_index_end]))
            data[ f'player_defensive_rating'].append(np.mean(self.player_defensive_rating[:self.round_index_end]))
            data[ f'player_defensive_rating_last{ self.last_number_games}'].append(np.mean(self.player_defensive_rating[self.round_index_begin:self.round_index_end]))
            data[ f'player_usage_rate'].append(np.mean(self.player_usage_rate[:self.round_index_end]))
            data[ f'player_usage_rate_last{ self.last_number_games}'].append(np.mean(self.player_usage_rate[self.round_index_begin:self.round_index_end]))
            data[ f'team_offensive_rating'].append(np.mean(self.team_offensive_rating[:self.round_index_end]))
            data[ f'team_offensive_rating_last{ self.last_number_games}'].append(np.mean(self.team_offensive_rating[self.round_index_begin:self.round_index_end]))
            data[ f'team_defensive_rating'].append(np.mean(self.team_defensive_rating[:self.round_index_end]))
            data[ f'team_defensive_rating_last{ self.last_number_games}'].append(np.mean(self.team_defensive_rating[self.round_index_begin:self.round_index_end]))
            data[ f'team_pace'].append(np.mean(self.team_pace[:self.round_index_end]))
            data[ f'team_pace_last{ self.last_number_games}'].append(np.mean(self.team_pace[self.round_index_begin:self.round_index_end]))
            data[ f'team_free_throw_attempt_rate'].append(np.mean(self.team_free_throw_attempt_rate[:self.round_index_end]))
            data[ f'team_free_throw_attempt_rate_last{ self.last_number_games}'].append(np.mean(self.team_free_throw_attempt_rate[self.round_index_begin:self.round_index_end]))
            data[ f'team_three_point_attempt_rate'].append(np.mean(self.team_three_point_attempt_rate[:self.round_index_end]))
            data[ f'team_three_point_attempt_rate_last{ self.last_number_games}'].append(np.mean(self.team_three_point_attempt_rate[self.round_index_begin:self.round_index_end]))
            data[ f'team_true_shooting_percentage'].append(np.mean(self.team_true_shooting_percentage[:self.round_index_end]))
            data[ f'team_true_shooting_percentage_last{ self.last_number_games}'].append(np.mean(self.team_true_shooting_percentage[:self.round_index_end]))
            ...
            data[ f'team_total_reboound_percentage_last{ self.last_number_games}'].append(np.mean(self.team_total_reboound_percentage[self.round_index_begin:self.round_index_end]))
            data[ f'team_assist_percentage'].append(np.mean(self.team_assist_percentage[:self.round_index_end]))
            data[ f'team_assist_percentage_last{ self.last_number_games}'].append(np.mean(self.team_assist_percentage[self.round_index_begin:self.round_index_end]))
            data[ f'team_steal_percentage'].append(np.mean(self.team_steal_percentage[:self.round_index_end]))
            data[ f'team_steal_percentage_last{ self.last_number_games}'].append(np.mean(self.team_steal_percentage[self.round_index_begin:self.round_index_end]))
            ...
            data[ f'team_offensive_effective_field_goal_percentage_last{ self.last_number_games}'].append(np.mean(self.team_offensive_effective_field_goal_percentage[self.round_index_begin:self.round_index_end]))
            ...
            data[ f'team_offensive_free_throws_per_field_goal_attempt_percentage_last{ self.last_number_games}'].append(np.mean(self.team_offensive_free_throws_per_field_goal_attempt_percentage[self.round_index_begin:self.round_index_end]))
            ...
            data[ f'team_defensive_free_throws_per_field_goal_attempt_percentage_last{ self.last_number_games}'].append(np.mean(self.team_defensive_free_throws_per_field_goal_attempt_percentage[self.round_index_begin:self.round_index_end]))
            ...
            data[ f'team_defensive_effective_field_goal_percentage_last{ self.last_number_games}'].append(np.mean(self.team_defensive_effective_field_goal_percentage[self.round_index_begin:self.round_index_end]))
            ...
            data[ f'opponent_defensive_rating_last{ self.last_number_games}'].append(np.mean(opponent_stats['defensive_rating'][self.round_index_begin:self.round_index_end]))
            data[ 'opponent_pace'].append(np.mean(opponent_stats['pace'][:self.round_index_end]))
            data[ f'opponent_pace_last{ self.last_number_games}'].append(np.mean(opponent_stats['pace'][:self.round_index_end]))
            ...
            data[ f'opponent_defensive_effective_field_goal_percentage_last{ self.last_number_games}'].append(np.mean(opponent_stats['defensive_effective_field_goal_percentage'][self.round_index_begin:self.round_index_end]))
            ...
            data[ f'opponent_defensive_turnover_percentage_last{ self.last_number_games}'].append(np.mean(opponent_stats['defensive_turnover_percentage'][self.round_index_begin:self.round_index_end]))
            ...
            data[ f'opponent_defensive_rebound_percentage_last{ self.last_number_games}'].append(np.mean(opponent_stats['defensive_rebound_percentage'][self.round_index_begin:self.round_index_end]))
            ...
            data[ f'opponent_defensive_free_throws_per_field_goal_attempt_percentage_last{ self.last_number_games}'].append(np.mean(opponent_stats['defensive_free_throws_per_field_goal_attempt_percentage'][self.round_index_begin:self.round_index_end]))
    ...
    def model_loader_predict_data(self,starts):
        ...
        to_be_predicted[ f'minutes_played_last{self.last_number_games}'].append(minutes_to_average(self.minutes_played_games[self.round_index_begin:self.round_index_end]))
        to_be_predicted['started'].append(starts)
        to_be_predicted[ f'player_ppg'].append(np.mean(self.player_points[:self.round_index_end]))
        to_be_predicted[ f'player_ppg_last{self.last_number_games}'].append(np.mean(self.player_points[self.round_index_begin:self.round_index_end]))
        to_be_predicted['player_field_goals'].append(np.mean(self.player_field_goals[:self.round_index_end]))
        to_be_predicted[ f'player_field_goals_last{self.last_number_games}'].append(np.mean(self.player_field_goals[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_field_goals_attempted'].append(np.mean(self.player_field_goals_attempted[:self.round_index_end]))
        to_be_predicted[ f'player_field_goals_attempted_last{self.last_number_games}'].append(np.mean(self.player_field_goals_attempted[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_field_goal_percentage'].append(np.mean(self.player_field_goal_percentage[:self.round_index_end]))
        to_be_predicted[ f'player_field_goal_percentage_last{self.last_number_games}'].append(np.mean(self.player_field_goal_percentage[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_three_pointers'].append(np.mean(self.player_three_pointers[:self.round_index_end]))
        to_be_predicted[ f'player_three_pointers_last{self.last_number_games}'].append(np.mean(self.player_three_pointers[self.round_index_begin:self.round_index_end]))
        ...
        to_be_predicted[ f'player_three_pointers_attempted_last{self.last_number_games}'].append(np.mean(self.player_three_pointers_attempted[self.round_index_begin:self.round_index_end]))
        ...
        to_be_predicted[ f'player_three_pointers_percentage_last{self.last_number_games}'].append(np.mean(self.player_three_pointers_percentage[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_free_throws'].append(np.mean(self.player_free_throws[:self.round_index_end]))
        to_be_predicted[ f'player_free_throws_last{self.last_number_games}'].append(np.mean(self.player_free_throws[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_free_throws_attempted'].append(np.mean(self.player_free_throws_attempted[:self.round_index_end]))
        to_be_predicted[ f'player_free_throws_attempted_last{self.last_number_games}'].append(np.mean(self.player_free_throws_attempted[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_free_throw_percentage'].append(np.mean(self.player_free_throw_percentage[:self.round_index_end]))
        to_be_predicted[ f'player_free_throw_percentage_last{self.last_number_games}'].append(np.mean(self.player_free_throw_percentage[self.round_index_begin:self.round_index_end]))
        ...
        to_be_predicted[ f'player_total_rebounds_last{self.last_number_games}'].append(np.mean(self.player_total_rebounds[:self.round_index_end]))
        to_be_predicted[ f'player_assists'].append(np.mean(self.player_assists[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_assists_last{self.last_number_games}'].append(np.mean(self.player_assists[:self.round_index_end]))
        to_be_predicted[ f'player_steals'].append(np.mean(self.player_steals[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_steals_last{self.last_number_games}'].append(np.mean(self.player_steals[:self.round_index_end]))
        to_be_predicted[ f'player_blocks'].append(np.mean(self.player_blocks[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_blocks_last{self.last_number_games}'].append(np.mean(self.player_blocks[:self.round_index_end]))
        to_be_predicted[ f'player_turnovers'].append(np.mean(self.player_turnovers[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_turnovers_last{self.last_number_games}'].append(np.mean(self.player_turnovers[:self.round_index_end]))
        to_be_predicted[ f'player_game_score'].append(np.mean(self.player_game_score[:self.round_index_end]))
        to_be_predicted[ f'player_game_score_last{self.last_number_games}'].append(np.mean(self.player_game_score[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_personal_fouls'].append(np.mean(self.player_personal_fouls[:self.round_index_end]))
        to_be_predicted[ f'player_personal_fouls_last{self.last_number_games}'].append(np.mean(self.player_personal_fouls[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_plus_minus'].append(np.mean([int(pm) for pm in self.player_plus_minus[:self.round_index_end]]))
        to_be_predicted[ f'player_plus_minus_last{self.last_number_games}'].append(np.mean([int(pm) for pm in self.player_plus_minus[self.round_index_begin:self.round_index_end]]))
        ...
        to_be_predicted[ f'player_true_shooting_percentage_last{self.last_number_games}'].append(np.mean(self.player_true_shooting_percentage[self.round_index_begin:self.round_index_end]))
        ...
        to_be_predicted[ f'player_effective_field_goal_percentage_last{self.last_number_games}'].append(np.mean(self.player_effective_field_goal_percentage[self.round_index_begin:self.round_index_end]))
        ...
        to_be_predicted[ f'player_total_rebound_percentage_last{self.last_number_games}'].append(np.mean(self.player_total_rebound_percentage[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_assist_percentage'].append(np.mean(self.player_assist_percentage[:self.round_index_end]))
        to_be_predicted[ f'player_assist_percentage_last{self.last_number_games}'].append(np.mean(self.player_assist_percentage[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_steal_percentage'].append(np.mean(self.player_steal_percentage[:self.round_index_end]))
        to_be_predicted[ f'player_steal_percentage_last{self.last_number_games}'].append(np.mean(self.player_steal_percentage[self.round_index_begin:self.round_index_end]))        
        to_be_predicted[ f'player_block_percentage'].append(np.mean(self.player_block_percentage[:self.round_index_end]))
        to_be_predicted[ f'player_block_percentage_last{self.last_number_games}'].append(np.mean(self.player_block_percentage[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_turnover_percentage'].append(np.mean(self.player_turnover_percentage[:self.round_index_end]))
        to_be_predicted[ f'player_turnover_percentage_last{self.last_number_games}'].append(np.mean(self.player_turnover_percentage[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_offensive_rating'].append(np.mean(self.player_offensive_rating[:self.round_index_end]))
        to_be_predicted[ f'player_offensive_rating_last{self.last_number_games}'].append(np.mean(self.player_offensive_rating[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_defensive_rating'].append(np.mean(self.player_defensive_rating[:self.round_index_end]))
        to_be_predicted[ f'player_defensive_rating_last{self.last_number_games}'].append(np.mean(self.player_defensive_rating[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'player_usage_rate'].append(np.mean(self.player_usage_rate[:self.round_index_end]))
        to_be_predicted[ f'player_usage_rate_last{self.last_number_games}'].append(np.mean(self.player_usage_rate[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'team_offensive_rating'].append(np.mean(self.team_offensive_rating[:self.round_index_end]))
        to_be_predicted[ f'team_offensive_rating_last{self.last_number_games}'].append(np.mean(self.team_offensive_rating[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'team_defensive_rating'].append(np.mean(self.team_defensive_rating[:self.round_index_end]))
        to_be_predicted[ f'team_defensive_rating_last{self.last_number_games}'].append(np.mean(self.team_defensive_rating[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'team_pace'].append(np.mean(self.team_pace[:self.round_index_end]))
        to_be_predicted[ f'team_pace_last{self.last_number_games}'].append(np.mean(self.team_pace[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'team_free_throw_attempt_rate'].append(np.mean(self.team_free_throw_attempt_rate[:self.round_index_end]))
        to_be_predicted[ f'team_free_throw_attempt_rate_last{self.last_number_games}'].append(np.mean(self.team_free_throw_attempt_rate[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'team_three_point_attempt_rate'].append(np.mean(self.team_three_point_attempt_rate[:self.round_index_end]))
        to_be_predicted[ f'team_three_point_attempt_rate_last{self.last_number_games}'].append(np.mean(self.team_three_point_attempt_rate[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'team_true_shooting_percentage'].append(np.mean(self.team_true_shooting_percentage[:self.round_index_end]))
        to_be_predicted[ f'team_true_shooting_percentage_last{self.last_number_games}'].append(np.mean(self.team_true_shooting_percentage[:self.round_index_end]))
        ...
        to_be_predicted[ f'team_total_reboound_percentage_last{self.last_number_games}'].append(np.mean(self.team_total_reboound_percentage[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'team_assist_percentage'].append(np.mean(self.team_assist_percentage[:self.round_index_end]))
        to_be_predicted[ f'team_assist_percentage_last{self.last_number_games}'].append(np.mean(self.team_assist_percentage[self.round_index_begin:self.round_index_end]))
        to_be_predicted[ f'team_steal_percentage'].append(np.mean(self.team_steal_percentage[:self.round_index_end]))
        to_be_predicted[ f'team_steal_percentage_last{self.last_number_games}'].append(np.mean(self.team_steal_percentage[self.round_index_begin:self.round_index_end]))
        ...
        to_be_predicted[ f'team_offensive_effective_field_goal_percentage_last{self.last_number_games}'].append(np.mean(self.team_offensive_effective_field_goal_percentage[self.round_index_begin:self.round_index_end]))
        ...
        to_be_predicted[ f'team_offensive_free_throws_per_field_goal_attempt_percentage_last{self.last_number_games}'].append(np.mean(self.team_offensive_free_throws_per_field_goal_attempt_percentage[self.round_index_begin:self.round_index_end]))
        ...
        to_be_predicted[ f'team_defensive_free_throws_per_field_goal_attempt_percentage_last{self.last_number_games}'].append(np.mean(self.team_defensive_free_throws_per_field_goal_attempt_percentage[self.round_index_begin:self.round_index_end]))
        ...
        to_be_predicted[ f'team_defensive_effective_field_goal_percentage_last{self.last_number_games}'].append(np.mean(self.team_defensive_effective_field_goal_percentage[self.round_index_begin:self.round_index_end]))
        ...
        to_be_predicted[ f'opponent_defensive_rating_last{self.last_number_games}'].append(np.mean(opponent_stats['defensive_rating'][self.round_index_begin:self.round_index_end]))
        to_be_predicted[ 'opponent_pace'].append(np.mean(opponent_stats['pace'][:self.round_index_end]))
        to_be_predicted[ f'opponent_pace_last{self.last_number_games}'].append(np.mean(opponent_stats['pace'][:self.round_index_end]))
        ...
        to_be_predicted[ f'opponent_defensive_effective_field_goal_percentage_last{self.last_number_games}'].append(np.mean(opponent_stats['defensive_effective_field_goal_percentage'][self.round_index_begin:self.round_index_end]))
        ...
        to_be_predicted[ f'opponent_defensive_turnover_percentage_last{self.last_number_games}'].append(np.mean(opponent_stats['defensive_turnover_percentage'][self.round_index_begin:self.round_index_end]))
        ...
        to_be_predicted[ f'opponent_defensive_rebound_percentage_last{self.last_number_games}'].append(np.mean(opponent_stats['defensive_rebound_percentage'][self.round_index_begin:self.round_index_end]))
        ...
        to_be_predicted[ f'opponent_defensive_free_throws_per_field_goal_attempt_percentage_last{self.last_number_games}'].append(np.mean(opponent_stats['defensive_free_throws_per_field_goal_attempt_percentage'][self.round_index_begin:self.round_index_end]))
